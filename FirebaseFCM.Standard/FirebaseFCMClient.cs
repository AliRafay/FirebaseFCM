// <copyright file="FirebaseFCMClient.cs" company="APIMatic">
...
namespace FirebaseFCM.Standard
{
    ...
    /// </summary>
    public sealed class FirebaseFCMClient : IConfiguration
    {
        ...
        {
            {
                ...
                {
                    { Server.Server1, "https://fcm.googleapis.com/fcm" },
                }
            },
        };
        ...
        /// <summary>
        /// Creates an object of the FirebaseFCMClient using the values provided for the builder.
        /// </summary>
        ...
        /// </summary>
        /// <returns> FirebaseFCMClient.</returns>
        internal static FirebaseFCMClient CreateFromEnvironment()
        {
            var builder = new Builder();

            string environment = System.Environment.GetEnvironmentVariable("FIREBASE_FCM_STANDARD_ENVIRONMENT");
        ...
        {
            private Environment environment = FirebaseFCM.Standard.Environment.Production;
